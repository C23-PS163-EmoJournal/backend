...
app.post("/api/createUser", (req, res) => {
  ...
  const sqlQuery =
    "INSERT INTO user (user_name, user_email, user_password) VALUE (?, ?, ?)";
...
app.put("/api/updateUser", (req, res) => {
  ...
  const sqlQuery =
    "UPDATE user SET user_name = ?, user_password = ? WHERE user_email = ?";
...
app.listen(3001, () => {
  console.log("server berhasil berjalan di port 3001!");
});
